...
class PuzzleGame {
  ...
  constructor(size, mode, imageSource, identifier, displayName) {
    ...
    console.log(`Game Instance Created: ID='${this.imageIdentifier}', Name='${this.imageDisplayName}', Image Source for original: ${imageSource ? imageSource.substring(0,50)+'...' : 'N/A'}`);
    this.initializeGame();
  }
  // --- 修改結束 ---
